# Netcore Design System Skill

Build UI that matches the Netcore product exactly — right colours, font, components, and states.

## Trigger

- `/ds` — apply this design system to the current request
- `/design-system` — same as above
- Auto-activates when building screens, forms, components, or UI for Netcore

## What this skill does

When triggered, read and apply ALL rules in this file before generating any code. Every colour, font, border, radius, component state, and disabled style is defined below. Do not use framework defaults (shadcn, MUI, Chakra) without overriding to match this spec.

## How to use

- `/ds create a campaign setup wizard` → Netcore-branded wizard with correct stepper, inputs, summary sidebar
- `/ds build an audience filter panel` → correct tokens, Manrope, white inputs, brand blue
- `create a generic form` (no `/ds`) → free generation, no design system applied

---

<!-- ============================================================ -->
<!-- FULL DESIGN SYSTEM SPEC BELOW — DO NOT EDIT ABOVE THIS LINE -->
<!-- ============================================================ -->
