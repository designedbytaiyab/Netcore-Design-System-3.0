...
> **Copywriting companion:** UI strings, voice, and Netcorian rules live in `copywriting/SKILL.md` and `copywriting/spec.md`. This file governs visual tokens and components only.  
